...
exclude_filter="${excludeFilter}"
export_files=${exportFiles}
export_path="builds/rokid/c02-place.apk"
encryption_include_filters=""
encryption_exclude_filters=""
encrypt_pck=false
encrypt_directory=false
...
package/name="GodotXRFoundation"
version/code=2
version/name="0.2.0-c02-rokid-place"
xr_features/xr_mode=1
xr_features/openxr_vendor_khronos=true
xr_features/openxr_vendor_meta=false
xr_features/openxr_vendor_pico=false
...
xr_features/openxr_vendor_lynx=false
screen/immersive_mode=true
command_line/extra_args="--xr-platform=rokid --xr-scene=rokid_place"
permissions/camera=true

[preset.4]

name="C04 iPad ARKit Place"
platform="iOS"
runnable=true
dedicated_server=false
custom_features=""
...
exclude_filter="${excludeFilter}"
export_files=${exportFiles}
export_path="builds/ipad/c04-place.zip"
encryption_include_filters=""
encryption_exclude_filters=""
encrypt_pck=false
encrypt_directory=false
...
icons/icon_1024x1024="res://assets/app_icon.svg"
application/export_project_only=true
privacy/camera_usage_description="C04 uses the camera for ARKit tracking and placement."
capabilities/arkit=true
plugins/GodotARKit=true
command_line/extra_args="--xr-platform=ipad --xr-scene=ios_arkit_place"
`;
}
