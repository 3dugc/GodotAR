...
const checks = [
	{
		...
		requirements: [
			...
			["Unity trackable type mask constants", /TRACKABLE_TYPE_PLANES/],
			["Unity trackable type mask variant mapper", /func\s+trackable_type_mask_from_variant\s*\(/],
			["Unity trackable type mask string mapper", /func\s+trackable_type_mask_from_string\s*\(/],
	...
	},
	{
		...
		requirements: [
			...
			["Unity Ray overload helper", /func\s+raycast_ray_to_list\s*\(/],
			["Unity RaycastRayToList alias", /func\s+RaycastRayToList\s*\(/],
			["Unity TryRaycastRay alias", /func\s+TryRaycastRay\s*\(/],
			["Unity Ray dictionary extraction", /func\s+_extract_ray\s*\(/],
			["Unity TrackableType mask conversion", /trackable_type_mask_from_variant/],
		],
	},
	{
	...
	},
	{
		...
		requirements: [
			...
			["plane GetPlane alias", /func\s+GetPlane\s*\(/],
			...
			["requested detection mode setter alias", /func\s+SetRequestedDetectionMode\s*\(/],
			["requested detection mode getter alias", /func\s+GetRequestedDetectionMode\s*\(/],
			["current detection mode getter alias", /func\s+GetCurrentDetectionMode\s*\(/],
	...
	},
	{
		...
		requirements: [
			...
			["anchor GetAnchor alias", /func\s+GetAnchor\s*\(/],
			...
			["anchor descriptor support", /supportsTrackableAttachments/],
			["anchor descriptor getter", /func\s+GetDescriptor\s*\(/],
			["Unity AttachAnchor alias", /func\s+AttachAnchor\s*\(/],
			["Unity TryAddAnchorAsync value field", /"value"\s*:\s*anchor/],
			["persistent anchor unsupported API", /func\s+TrySaveAnchorAsync\s*\(/],
