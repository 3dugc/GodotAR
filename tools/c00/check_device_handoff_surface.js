...
const checks = [
	{
		...
		requirements: [
			...
			"android-adb-recovery-rokid-*.md",
			"android-adb-recovery-rokid-*.json",
			"android-adb-recovery-android-arcore-*.md",
			"android-adb-recovery-android-arcore-*.json",
			"ipad-ddi-recovery-*.md",
			"ipad-ddi-recovery-*.json",
			"device-ready-android-arcore-*.json",
			"Latest readiness/recovery evidence",
