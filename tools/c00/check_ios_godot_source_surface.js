...
const checks = [
	...
	},
	{
		...
		requirements: [
			...
			["GDExtension interface generator", /make_interface_header/],
			...
			["required GDExtension interface header", /core\/extension\/gdextension_interface\.gen\.h/],
	...
	},
	{
		...
		requirements: [
			...
			["validates GDExtension interface header", /core\/extension\/gdextension_interface\.gen\.h/],
	...
	},
	{
		...
		requirements: [
			...
			["GDExtension generated header readiness", /gdextension_interface\.gen\.h/],
		],
	},
	{
		...
		requirements: [
			...
			["GDExtension generated header preflight", /gdextension_interface\.gen\.h/],
		],
	},
	{
		...
		requirements: [
			...
			["GDExtension generated header cycle guard", /gdextension_interface\.gen\.h/],
			...
			["iOS export project gate after export", /check_ios_export_project\.js/],
