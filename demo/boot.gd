...
const SCENE_ALIASES := {
	...
	"place_on_plane": "res://demo/01_place_on_plane.tscn",
	"c01_place": "res://demo/01_place_on_plane.tscn",
	"backend_switcher": "res://demo/02_backend_switcher.tscn",
	"c01_backend": "res://demo/02_backend_switcher.tscn",
