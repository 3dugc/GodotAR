...
- 新增 C00 一键静态 gate，汇总 Node/Bash 语法、Godot project/scene、ARFoundation、XRI、OpenXR/Rokid 和 iOS plugin 静态检查，并生成 Markdown/JSON 报告。
...
```text
GXF_SMOKE|{"cycle":"C00","event":"session_started","runtime":{"godot":...,"cmdline_xr_args":["--xr-platform=rokid"],...},"backend":"OpenXR","session_state":"Running","ar_session_state":"SessionTracking","not_tracking_reason":"None","capabilities":{"openxr_ar_evidence":["environment_blend:alpha_blend"]},"xri":{"interaction_manager":true,"ray_interactor":true},...}
```
