...
- `tools/c00/check_export_presets.js` now validates that `export_presets.cfg` contains the required C00 preset names before export, and requires Rokid exports to include `--xr-platform=rokid`.
