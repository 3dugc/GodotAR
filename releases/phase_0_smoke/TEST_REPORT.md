...
- The local cached device-lab editor is still Godot 4.4.1 stable and runs successfully outside the Codex sandbox: `4.4.1.stable.official.49a5bc7b6`. This is retained as legacy evidence; new device-machine setup should install the C00 default latest line with `tools/c00/install_godot_editor.sh --download --latest`, currently `4.7-rc1`, unless the operator explicitly pins a fallback version.
